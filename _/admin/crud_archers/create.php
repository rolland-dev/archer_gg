...
$nom = $prenom = $sexe = $daten = $email = $tel = $mobile = $pere = $mere = $numlicence = $droitimg = $license = $certif = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($nom_err) && empty($prenom_err) && empty($sexe_err) && empty($daten_err) && empty($email_err) ){
            ...
            $sql = "INSERT INTO archers (nom, prenom, sexe, date_n , email,tel,mobile,pere,mere,numlicence,licence,droitimg,certif, valide) VALUES ( '$param_nom', '$param_prenom', '$param_sexe', '$param_daten', '$param_email', '$param_tel', '$param_mobile','$param_pere', '$param_mere', '$param_numlicence', '$param_licence','$param_droitimg', '$param_certif', '$param_valide')";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="droitimg" class="form-control">
                        </div>
                        <div class="form-group">
