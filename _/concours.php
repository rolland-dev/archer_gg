                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    echo "<thead>";
                                        echo "<tr>";
                                            echo "<th>Nom</th>";
                                            echo "<th>Prénom</th>";
                                            echo "<th class='mobile'>Catégorie</th>";
                                            echo "<th class='mobile'>Date</th>";
                                            echo "<th class='mobile'>Groupe</th>";
                                            echo "<th>Points</th>";
                                            echo "<th>Place</th>";
                                        echo "</tr>";
                                    echo "</thead>";
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        if($groupe!=$groupe1){
                                            ...
                                            echo "<tr>";
                                                ...
                                                echo "<td class='mobile'>" . $row['categorie'] . "</td>";
                                                echo "<td class='mobile'>" . date('d-m-Y', strtotime($row['date'])) . "</td>";
                                                echo "<td class='mobile'>" . $row['groupe'] . "</td>";
                                                echo "<td>" . $row['points'] . "<span class='mobile'> points </span></td>";
                                                echo "<td>" . $row['classement'] . "<span class='groupe'> : G". $row['groupe'] ."</span></td>";
                                            echo "</tr>";
                                            $groupe+=1;
                                        }else{
                                            echo "<tr>";
