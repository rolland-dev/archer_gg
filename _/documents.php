                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    echo "<thead>";
                                        echo "<tr>";
                                            ...
                                            echo "<th class='mobile'>Titre</th>";
                                            echo "<th class='mobile'>Documents</th>";
                                        echo "</tr>";
                                    echo "</thead>";
                                    echo "<tbody>";
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr>";
                                            ...
                                            echo "<td class='mobile'>" . $row['titre'] . "</td>";
                                            echo "<td class='mobile'><a href='".$row['lien']."' target='_blank'>". $row['lien']. "</a></td>";
