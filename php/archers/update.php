...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($nom_err) && empty($prenom_err) && empty($sexe_err) && empty($daten_err) ){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            mysqli_stmt_bind_param($stmt, "sssssssssi", $param_nom, $param_prenom, $param_sexe, $param_daten, $param_email, $param_tel, $param_mobile, $param_pere, $param_mere, $param_id);
