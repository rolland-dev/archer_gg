...
if(isset($_SESSION['login'])){
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $tableau=array();
    $sql2 = "SELECT DENSE_RANK() OVER(PARTITION BY groupe ORDER BY points DESC) as classement , points, id, groupe FROM `inscriptions`";
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                $sql = "SELECT * FROM inscriptions ORDER BY date, points DESC, groupe ASC";
