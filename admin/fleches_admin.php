...
if (isset($_POST['submit'])) {
    ...
    if(empty($couleur_err) && empty($point_err) && empty($date_err) ){
      ...
      $sql = "INSERT INTO fleches (couleur, point, date, archers_id ,validateur, valide) VALUES ( '$param_couleur', '$param_point', '$param_date', '$param_archers_id','$param_validateur', '$param_valide')";
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Obtention d'une <?= $choix ?> avec <?= $total ?> points</h2><br>
