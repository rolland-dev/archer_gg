...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($categorie_err)){
        ...
        $param_id = $_GET['id'];
        $sql = "UPDATE cibles SET $champ3 WHERE id=$param_id";
        
        $result = mysqli_query($link, $sql);
            if($result){   
                header("location: ../cibles_admin.php");
                exit();
            } else{
    ...
    if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
        ...
        $sql = "SELECT * FROM cibles WHERE id = ?";
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Mise a jour d'un équipement de ciblerie</h2>
                    ...
                    <div class="text-center">
                        ...
                        <a href="../cibles_admin.php" class="btn btn-secondary ml-2">Annuler</a>
                    </form>
                </div>
            </div>
        </div>
